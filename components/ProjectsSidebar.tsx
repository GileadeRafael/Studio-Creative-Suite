        ...
        <nav className="space-y-2.5 w-full flex flex-col items-center">
          {projects.map(project => (
            <div key={project.id} className="relative w-full flex justify-center group">
              ...
              {/* Hover Info Panel */}
              <div className="absolute left-full ml-3 w-48 bg-zinc-900 border border-zinc-700 rounded-lg p-2 shadow-lg flex items-center z-20 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-200">
