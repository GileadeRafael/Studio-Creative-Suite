        ...
        <div className="w-full max-w-md mx-auto">
          {signupSuccess ? (
            <div className="text-center">
              <img src="https://framerusercontent.com/images/CHVGn1yl906NV0lL0JCifCk1as.png" alt="Studio Logo" className="w-16 h-16 mx-auto mb-6" />
              <h2 className="text-3xl font-bold text-gray-100">Verifique seu E-mail</h2>
              ...
              <p className="mt-2 text-gray-400">
                Por favor, clique no link para ativar sua conta antes de fazer o login.
              </p>
              <button 
                onClick={onNavigateToLogin} 
                className="mt-8 w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:ring-red-500"
              >
                Voltar para o Login
              </button>
            </div>
